...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/604aa7e968e4b80016333a5b
...
To start editing your site, you can use the Sanity interface at https://clever-eucalyptus-aa7e9.sanity.studio/.
...
Generated at `2021-03-11T23:31:34.484Z` by Stackbit version `0.3.50`.